...
int main(){
    ...
    do {
        ...
        switch(pil) {
            ...
            default:
                cout << "\nTERIMA KASIH" << endl;
                cout << "Program was made by M.Anshary (2410817310008)." << endl; 
            }
        ...
        void cariData() {
            if(isEmpty() == 0) {
                string cari;
                cout<<"Masukkkan data yang ingin dicari : ";
                cin>>cari;
        ...
        void sisipkanSetelah() {
            if(isEmpty() == 0) {
                ...
                if(apaAda==true) {
                    ...
                    cout << "Data \""<<dataBaru<<"\" berhasil disipkan setelah data \""<<prevData<<"\"."<<endl;
                } else {
